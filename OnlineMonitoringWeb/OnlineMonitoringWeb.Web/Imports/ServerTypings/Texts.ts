namespace OnlineMonitoringWeb.Texts {
    ...
    declare namespace Db {
        ...
        namespace Hierarchy {
            ...
            namespace Area {
                ...
                export const DistributionId: string;
                export const DistributionName: string;
                export const DistributionRegionalId: string;
                export const Name: string;
            }
            ...
            namespace Distribution {
                export const DistributionId: string;
                export const Name: string;
                export const RegionalId: string;
                export const RegionalName: string;
            }
            ...
            namespace RankInHierarchy {
                export const AreaDistributionId: string;
                export const AreaId: string;
                export const AreaName: string;
                export const DistributionId: string;
                export const DistributionName: string;
                export const DistributionRegionalId: string;
                export const RankId: string;
                export const RegionalId: string;
                export const RegionalName: string;
                export const StationAreaId: string;
                export const StationId: string;
                export const StationName: string;
                export const UnitCapacity: string;
                export const UnitId: string;
                export const UnitName: string;
                export const UnitStationId: string;
