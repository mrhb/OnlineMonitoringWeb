...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Hierarchy
        {
            ...
            {
                public const string AreaIndex = "~/Modules/Hierarchy/Area/AreaIndex.cshtml";
            }

            public static class Distribution
            {
                public const string DistributionIndex = "~/Modules/Hierarchy/Distribution/DistributionIndex.cshtml";
            }

            public static class Province
            {
                public const string ProvinceIndex = "~/Modules/Hierarchy/Province/ProvinceIndex.cshtml";
            }

            public static class RankInHierarchy
            {
                public const string RankInHierarchyIndex = "~/Modules/Hierarchy/RankInHierarchy/RankInHierarchyIndex.cshtml";
            }

            public static class Regional
            {
                public const string RegionalIndex = "~/Modules/Hierarchy/Regional/RegionalIndex.cshtml";
            }

            public static class Station
            {
                public const string StationIndex = "~/Modules/Hierarchy/Station/StationIndex.cshtml";
            }

            public static class Unit
            {
                public const string UnitIndex = "~/Modules/Hierarchy/Unit/UnitIndex.cshtml";
            }
